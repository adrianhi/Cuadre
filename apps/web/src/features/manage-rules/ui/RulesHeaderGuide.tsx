          ...
          <div className="flex items-center gap-2.5 text-primary">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Automatiza tu dinero para no clasificar las mismas compras una y
                otra vez.
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-1 gap-3 pt-3 border-t border-border/40 sm:grid-cols-3">
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-foreground">
                  1. Automatiza el futuro
                </p>
                <p className="text-[11px] text-muted-foreground leading-relaxed mt-0.5">
                  Cada nueva alerta o compra de este comercio se etiquetará sola
                  al llegar.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground leading-relaxed mt-0.5">
                  Con un clic puedes reclasificar meses anteriores para cuadrar
                  tus presupuestos.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-foreground">
                  3. Ediciones protegidas
                </p>
                <p className="text-[11px] text-muted-foreground leading-relaxed mt-0.5">
                  Los movimientos que tú hayas cambiado a mano nunca se
                  sobreescriben.
                </p>
              </div>
            </div>
