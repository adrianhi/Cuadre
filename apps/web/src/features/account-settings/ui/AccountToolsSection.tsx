...
export function AccountToolsSection(props: {
  ...
  const tools = props.mode === 'automation' ? automationTools : accountTools;
  return (
    <section className="space-y-3 rounded-2xl border p-4">
      <div><p className="font-bold">{props.mode === 'automation' ? 'Automatización' : 'Herramientas y apariencia'}</p><p className="text-xs text-muted-foreground">{props.mode === 'automation' ? 'Organiza movimientos y configura tu ciclo de ingresos.' : 'Acciones menos frecuentes de tu cuenta.'}</p></div>
