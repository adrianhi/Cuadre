...
export const ControlSection: React.FC<ControlSectionProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sticky top-0 z-20 -mx-4 sm:-mx-6 px-4 sm:px-6 py-2.5 bg-background/90 backdrop-blur-md border-b border-border/40">
        <div className="mx-auto max-w-md rounded-2xl bg-muted/80 p-1 text-xs font-semibold text-muted-foreground shadow-inner flex gap-1">
          <button
            type="button"
