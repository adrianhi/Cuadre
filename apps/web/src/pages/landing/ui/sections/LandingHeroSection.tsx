  ...
  return (
    <section className="relative overflow-hidden pt-12 pb-16 md:pt-20 md:pb-24">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 text-center">
        {/* Cohort badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3.5 py-1 text-xs font-medium text-emerald-300 backdrop-blur-xs mb-6 animate-in fade-in duration-500">
        ...
        {/* Waitlist Form */}
        <div id="beta-waitlist" className="mt-8 flex scroll-mt-28 justify-center">
