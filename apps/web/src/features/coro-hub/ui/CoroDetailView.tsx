...
import { Archive, ArrowLeft, Copy, ExternalLink, LockKeyhole, ReceiptText, Scale, Users } from 'lucide-react';
      ...
      <header className="min-w-0 rounded-2xl border bg-card p-4 sm:p-6">
        <div className="flex min-w-0 flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            <div className="flex min-w-0 items-center gap-2"><h2 className="truncate text-2xl font-black sm:text-3xl">{detail.name}</h2><span className="shrink-0 rounded-full bg-primary/10 px-2.5 py-1 text-[10px] font-bold text-primary">{statusLabel[detail.status]}</span></div>
